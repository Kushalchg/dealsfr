    ...
    <SidebarProvider>
      <Sidebar className="mt-2 bg-gray-900 pt-20">
        <SidebarContent className="px-2 md:px-3 py-4 bg-gray-900 border-r-2 border-white">
          <SidebarGroup>
            <SidebarGroupLabel className="text-emerald-400 text-xs uppercase tracking-wider font-semibold mb-3 px-2 md:px-3">
            </SidebarGroupLabel>
            <SidebarGroupContent>
        ...
        <SidebarFooter className="border-r-2 border-white p-2 md:p-4 bg-gray-900">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 md:w-56 bg-gray-800 border-gray-600">
              <DropdownMenuLabel className="text-gray-200 font-semibold text-sm md:text-base">My Account</DropdownMenuLabel>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-9 w-9">
                        ...
                        <AvatarFallback className="bg-emerald-600 text-white text-sm font-semibold">{userInitials}</AvatarFallback>
                      </Avatar>
                      <div className="flex-1 min-w-0 text-left">
                        <div className="text-white font-semibold truncate">{user.first_name} {user.last_name}</div>
                        <div className="text-xs text-gray-400 truncate">{user.email}</div>
                      </div>
                    </Button>
                  </DropdownMenuTrigger>
          ...
          <main className="pt-20 md:pt-24 flex-1 bg-background px-2 md:px-4">{children}</main>
        </div>
